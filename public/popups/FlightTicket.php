    ...
    <div class="modal-body">
        <div class="row">
            <form id="flight-ticket-form" class="form-horizontal" role="form">
                ...
                <div class="col-md-6">
                    <div class="panel">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="first_name_FT" id="first_name_FT">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="last_name_FT" id="last_name_FT">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="passport_number_FT" id="passport_number_FT">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="employer_name_FT" id="employer_name_FT">
                            </div>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="phone_contact_FT" class="col-md-4 control-label">סוג כרטיס</label>
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="phone_contact_FT" id="phone_contact_FT">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="dereliction_date_FT" id="dereliction_date_FT">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input type="text" class="form-control" name="arrival_date_FT" id="arrival_date_FT">
                        </div>
                    </div>
